<?php
  ...
  // check username and password against requirements
  ...
  // TODO: Create JSON document for a default user registering
  ...
  if (!isset($_SESSION["TOKEN"])) {
    ...
    curl_setopt($ch, CURLOPT_URL, $_SESSION["COUCHDB"]."/"); // use couchdb register function
